...
namespace WavpackDecoder
{
    class WordsUtils
    {
        ...
        internal static int get_words(long nsamples, long flags, words_data w, Bitstream bs, int[] buffer)
        {
            entropy_data[] c = w.c;
            int csamples;
            int buffer_counter = 0;
        ...
        internal static int read_code(Bitstream bs, int maxcode)
        {
