...
namespace WavpackDecoder
{
    class UnpackUtils
    {
        ...
        internal static long unpack_samples(WavpackContext wpc, int[] buffer, long sample_count)
        {
            WavpackStream wps = wpc.stream;
            ...
            if ((flags & (Defines.MONO_FLAG | Defines.FALSE_STEREO)) > 0)
            {
                ...
                Array.Copy(temp_buffer, 0, buffer, 0, (int) sample_count);
            ...
            else
            {
                ...
                Array.Copy(temp_buffer, 0, buffer, 0, (int) (sample_count * 2));
        ...
        internal static int[] fixup_samples(WavpackStream wps, int[] buffer, long sample_count)
        {
            long flags = wps.wphdr.flags;
